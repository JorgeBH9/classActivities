...
1. Your HTML should have each of the following sections:
   * Header - DONE
   * Nav - DONE
   * Aside (With a Heading) - DONE
   * Section (With a Heading) - DONE
   * Article (With a Heading) contained within the Section - DONE
   * Headers contained within the Article - DONE
   * Paragraph contained within the Article - DONE
2. Your CSS should have styles for each of the following elements:
   * Body
     * font-family: 'Arial', 'Helvetica Neue', Helvetica, sans-serif; - DONE
     * color: '#777' - DONE
     * background: '#777' - DONE
     * width: '960px' - DONE
     * font-size: '18px' - DONE
   * Header, Nav, Section, Aside, and Footer
     * background: '#ebebeb' - DONE
   * Article
     * color: '#ebebeb', - DONE
     * background: '#777' - DONE
   * h1 and p
